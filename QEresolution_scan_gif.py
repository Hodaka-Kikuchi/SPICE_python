# do not use this code. please use QEresolution_scan.py
...
def calcresolution_scan_with_gif(A_sets,QE_sets,bpe,fixe,Hfocus,num_ana,entry_values,initial_index=0,save_gif=True,gif_name="resolution.gif"):
